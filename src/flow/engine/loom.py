...
class Loom:
    ...
    def insert(self, path: Path, anchor: str, content: str,
        ...
        # We enforce UTF-8 for now. If it fails to strict decode,
        # it might be binary or legacy.
        try:
        ...
        # Implementation: Simple normalization (strip lines) implies
        # we operate line-by-line. But we are doing string find.
